/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: fe49b520f3cb50b5fd3e3eba60ee3b6e)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	DESTINATION_FEBJON: string;
	DESTINATION_STEAMDUSK: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DESTINATION_FEBJON" | "DESTINATION_STEAMDUSK">> {}
}
