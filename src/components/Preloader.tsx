...
export function Preloader(){
  ...
  return <div className="fixed inset-0 z-[10000] grid place-items-center overflow-hidden bg-[#07111d] text-ca-text" role="status" aria-label="Cargando Casa Atenta">
    ...
    <div className="ca-preloader flex flex-col items-center gap-7">
      ...
      <div className="text-center"><p className="text-[10px] uppercase tracking-[.42em] text-brand-gold">Casa Atenta</p><p className="mt-3 text-[8px] uppercase tracking-[.28em] text-ca-text-secondary">Diseño · ejecución · control</p></div>
    </div>
  </div>;
}
