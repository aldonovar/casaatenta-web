...
export const WhatsAppButton: React.FC<WhatsAppButtonProps> = ({
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noopener noreferrer"
      className={`glow-btn group inline-flex min-h-12 items-center justify-center gap-2 border px-6 py-3.5 text-[10px] font-mono uppercase tracking-widest transition-all duration-300 ${variantClass} ${className}`}
    >
