...
export const Footer: React.FC = () => {
  ...
  return (
    <footer ref={containerRef} className="relative bg-ca-bg-deep pt-16 pb-12 md:pt-24 md:pb-16 overflow-hidden border-t border-ca-border/20 transition-colors duration-800">
      ...
      <div className="max-w-[1700px] mx-auto px-6 md:px-12 lg:px-20 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 mb-16 md:mb-20">
          ...
          <div className="md:col-span-4 space-y-8 footer-fade-in">
            ...
            <p className="text-xs md:text-sm font-light leading-relaxed max-w-sm text-ca-text-secondary transition-colors duration-800">
          ...
          <div className="md:col-span-2 space-y-6 footer-fade-in">
            <h5 className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-gold border-b border-ca-border/20 pb-3">Explora</h5>
            <div className="flex flex-col space-y-3.5 text-xs font-mono uppercase tracking-wider text-ca-text-secondary">
          ...
          <div className="md:col-span-3 space-y-6 footer-fade-in">
            <h5 className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-gold border-b border-ca-border/20 pb-3">Especialidades</h5>
            <div className="flex flex-col space-y-3.5 text-xs font-mono uppercase tracking-wider text-ca-text-secondary">
          ...
          <div className="md:col-span-3 space-y-6 footer-fade-in">
            <h5 className="text-[10px] font-mono uppercase tracking-[0.2em] text-brand-gold border-b border-ca-border/20 pb-3">Contacto</h5>
            <ul className="space-y-5">
              <li className="space-y-1">
                <span className="block text-[9px] font-mono uppercase tracking-widest text-ca-text-secondary/50">WhatsApp</span>
                <a 
                  href={WHATSAPP_LINK}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-xs font-mono uppercase tracking-wider text-ca-text hover:text-brand-gold transition-colors block"
                >
                  +51 908 550 942
                </a>
              </li>
              <li className="space-y-1">
                <span className="block text-[9px] font-mono uppercase tracking-widest text-ca-text-secondary/50">Email</span>
                <a 
                  href="mailto:contacto@casa-atenta.com"
                  className="text-xs font-mono uppercase tracking-wider text-ca-text hover:text-brand-gold transition-colors block break-all"
                >
        ...
        <div className="w-full border-t border-ca-border/20 pt-8 flex flex-col gap-4">
          <div className="overflow-hidden flex flex-col md:flex-row md:items-baseline md:justify-between w-full">
             ...
             <span className="text-[9px] font-mono tracking-[0.22em] text-brand-gold/60 uppercase mt-2 md:mt-0">
               00 // ARQUITECTURA RESIDENCIAL & DOMÓTICA
             </span>
          </div>
          
          {/* Lower Bottom Bar */}
          <div className="footer-fade-in flex flex-col lg:flex-row justify-between items-center text-[9px] font-mono tracking-[0.18em] text-ca-text-secondary/50 uppercase mt-6 border-t border-ca-border/10 pt-6 gap-6">
